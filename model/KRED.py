...
class KREDModel(nn.Module):
    def __init__(self, config, user_history_dict, doc_feature_dict, entity_embedding, relation_embedding, adj_entity,
        ...
        self.user_modeling = User_modeling(config, user_history_dict, self.config['model']['embedding_dim'],
                                           self.config['model']['embedding_dim'], doc_feature_dict, entity_embedding,
                                           relation_embedding, adj_entity, adj_relation, entity_num, position_num,
                                           type_num, self.device)
